        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="span4">
                    ...
                    <br />
                    <asp:Label ID="CS_lbl_TimeClock" EnableViewState="false" runat="server"></asp:Label>
                    <br />
                    <asp:Label ID="CS_lbl_Sessions" EnableViewState="false" runat="server"></asp:Label>
                    <br />
                </div>
                <div class="span4">
                    ...
                    <br />
                    <asp:Button ID="CS_btn_RebootCloudServer" runat="server" CssClass="btn-primary" OnClick="CS_btn_RebootServer_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Reboot CloudServer" />
                    <br />
                    <br />
                    <asp:Button ID="CS_btn_DeleteCloudServer" runat="server" CssClass="btn-primary" OnClick="CS_btn_DeleteServer_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Delete CloudServer" />
                    <br />
                    <br />
                    <asp:TextBox ID="CS_txt_PasswdReset" runat="server"></asp:TextBox>
                    <br />
                    <asp:Button ID="CS_btn_PasswdReset" runat="server" CssClass="btn-primary" OnClick="CS_btn_PasswdReset_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Reset Passwd" />
                    <br />
                    <br />
                    Attached Volumes : 
                    <br />
                    ...
                    <br />
                    <asp:Button ID="CS_btn_AttachVolume" runat="server" CssClass="btn-primary" OnClick="CS_btn_AttachVolume_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Attach Volume" />
                    <br />
                    <br />
                    <asp:Button ID="CS_btn_DetachVolume" runat="server" CssClass="btn-primary" OnClick="CS_btn_DetachVolume_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Detatch Volume" />
                    <br />
                </div>
                <div class="span4">
                    Cloud Server Info :
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="CS_ddl_Region" />
                <asp:AsyncPostBackTrigger ControlID="CS_ddl_ListServers" />
                <asp:AsyncPostBackTrigger ControlID="CS_btn_RebootCloudServer" />
                <asp:AsyncPostBackTrigger ControlID="CS_btn_DeleteCloudServer" />
                <asp:AsyncPostBackTrigger ControlID="CS_btn_PasswdReset" />
                <asp:AsyncPostBackTrigger ControlID="CS_btn_AttachVolume" />
                <asp:AsyncPostBackTrigger ControlID="CS_btn_DetachVolume" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
    <div class="row">
        <div class="span4">
            ...
            <br />
            <asp:Button ID="CS_btn_CreateCloudServer" runat="server" CssClass="btn-primary" OnClick="CS_btn_CreateServer_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Create Cloud Server" />
            <br />
        </div>
    </div>
    <br />
