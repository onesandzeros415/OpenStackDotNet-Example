        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="span4">
                    ...
                    <br />
                    <asp:Label ID="CBS_lbl_TimeClock" EnableViewState="false" runat="server"></asp:Label>
                    <br />
                </div>
                <div class="span4">
                    Available Volumes:
                    <br />
                    <asp:DropDownList ID="CBS_ddl_ListVolumes" OnSelectedIndexChanged="CBS_ddl_ListVolumes_SelectChange" AutoPostBack="true" runat="server"></asp:DropDownList>
                    <br />
                    <asp:Button ID="CBS_btn_DeleteVolume" runat="server" CssClass="btn-primary" OnClick="CBS_btn_DeleteVolume_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Delete Volume" />
                    <br />
                    <asp:Label ID="CBS_lbl_VolumeStatus" EnableViewState="false" runat="server"></asp:Label>
                    <br />
                </div>
                <div class="span4">
                    Available Snapshots:
                    ...
                    <br />
                    <asp:Button ID="CBS_btn_DeleteSnapShot" runat="server" CssClass="btn-primary" OnClick="CBS_btn_DeleteSnapShot_Click" OnClientClick="javascript:return confirmAction(this.name);" Text="Delete SnapShot" />
                    <br />
                    <asp:Label ID="CBS_lbl_SnapshotStatus" EnableViewState="false" runat="server"></asp:Label>
                    <br />
                </div>
                </div>
                <br />
                <div class="row">
                    <div class="span6">
                        ...
                        New Volume Type:
                        <br />
                        <asp:DropDownList ID="CBS_ddl_ListVolumeType" runat="server">
                        </asp:DropDownList>
                        <asp:Button ID="CBS_btn_CreateVolume" runat="server" CssClass="btn-primary" OnClick="CBS_btn_CreateVolume_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Create Volume" />
                        <br />
                    </div>
                    <div class="span2"></div>
                    <div class="span6">
                        ...
                        <asp:Button ID="CBS_btn_CreateSnapShot" runat="server" CssClass="btn-primary" OnClick="CBS_btn_CreateSnapShot_OnClick" OnClientClick="javascript:return confirmAction(this.name);" Text="Create SnapShot" />
                        <br />
                    </div>
            </ContentTemplate>
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="CBS_ddl_Region" />
                <asp:AsyncPostBackTrigger ControlID="CBS_ddl_ListVolumes" />
                <asp:AsyncPostBackTrigger ControlID="CBS_btn_DeleteVolume" />
                <asp:AsyncPostBackTrigger ControlID="CBS_btn_DeleteSnapShot" />
                <asp:AsyncPostBackTrigger ControlID="CBS_btn_CreateVolume" />
                <asp:AsyncPostBackTrigger ControlID="CBS_btn_CreateSnapShot" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
    <div class="row">
